...
const Header = () => {
  return (
    ...
    <div className="container md:mx-auto mx-5">
      <div className="grid grid-cols-1 md:grid-cols-2 md:flex md:justify-between md:items-center md:mx-24 lg:mx-0">
        <div className="">
          <h1 className="lg:text-5xl text-2xl font-semibold">Mackbook Pro</h1>
          <p className="text-base font-light">
            Country to popular belief, Lorem ipsum is not simply random text. It
          ...
          <button className="bg-black text-white px-3 py-1 rounded flex justify-between items-center text-base">
            BUY NOW
